...
{
    all.idctRow_instance_Final = a;
    actor_Final_init(a);
    api.run = (run_t *)all.idctRow_instance_Final->run;
    api.end = (end_t *)all.idctRow_instance_Final->end;
    api.not_finished = (not_finished_t *)all.idctRow_instance_Final->not_finished;
    return &api;
}
int main(void) {
